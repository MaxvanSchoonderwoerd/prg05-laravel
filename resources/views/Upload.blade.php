...
@section('content')
    ...
    <section class="section">
        <form class="form" action="{{route('post.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <input class="hidden" id="m_audio" name="m_audio" type="file" accept="audio/*"
            ...
            <div class="mb-3">
                <input class="hidden" id="m_cover" name="m_cover" type="file" accept="image/*" placeholder="upload cover art">
