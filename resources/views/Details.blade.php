        ...
        @if(Auth::id() == $post->user_id)
            ...
            <div class="container">
                <form class="form" action="{{route('post.update', $post->id)}}" method="post"
                    ...
                    @method('PUT')
                    <div class="mb-3">
                        <input class="form-control" type="text" id="title" name="title" maxlength="40"
                ...
                <textarea class="form-control" type="text" id="description" name="description" maxlength="240"
                    ...
                    <div class="form-row">
                        <div class="mb-3">
                            <input class="form-control" type="number" id="bpm" name="bpm" placeholder="bpm"
                                   min="30" max="300" value="{{$post->bpm}}">
                        </div>
                        <div class="mb-3">
